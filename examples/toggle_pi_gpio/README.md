...
```
wget https://raw.githubusercontent.com/Soumya-Das-2006/Train-and-Deploy-YOLO-Models-Raspberry_pi-Jetson_Nano/refs/heads/main/examples/toggle_pi_gpio/toggle_pi_gpio.py
```
